...
def generateAnswer(
    ...
    if llm is None:
        ...
        return (
            "StudySense AI could not be loaded. "
            "Check the terminal for the AI error."
        )

    try:

        prompt = f"""
You are StudySense, an AI study assistant.

Answer the student's question using only
the study material provided.

If the answer is not contained in the study
material, say that you cannot find the answer
...
Create exactly {number} flashcards using ONLY
the study material.
...
Put each question and answer on its own line.

Do not number the cards.
Do not add introductions.
Do not add explanations outside of the cards.
...
"""
        ...
        if "Study Material:" in generatedText:
